...
import com.wanaia.domain.user.security.CustomUserDetailsService;
import com.wanaia.domain.user.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(Arrays.asList("Authorization", "Content-Type", "X-Correlation-ID", "Accept-Language", "X-Requested-With"));
